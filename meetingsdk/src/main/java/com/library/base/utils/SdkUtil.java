...
public class SdkUtil {
     ...
     * @return 权限是否可用
     */
    public static void getUserPermission(final PermissionCallBack callBack, final Activity context, final String... permission) {
        context.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    rxPermissions.request(permission).subscribe(new Observer<Boolean>() {
