...
//        打印分辨率
        LogResolutionRatio(dm);
        handler = new Handler(Looper.getMainLooper());
//        设置全屏
//        StatusBarUtil.hideStatusNavigationBar(this);

//        设置状态栏颜色
        StatusBarUtil.setStatusBarColorWhite(this,R.color.colorPrimary);
     ...
     * @param dm
     */
    private void LogResolutionRatio(DisplayMetrics dm) {
        Logcat.INSTANCE.e("dm.widthPixels=============="+dm.widthPixels);
        Logcat.INSTANCE.e("dm.heightPixels=============="+dm.heightPixels);
    }
    ...
    public void initActionBar() {
        ...
        if (!TextUtils.isEmpty(getTitle()) && !BuildConfig.APP_NAME.contentEquals(getTitle())) {
            setTitle(getTitle());
        }
    }
    ...
    public void showToast(final String msg) {
        LoadingDialog.toast(getContext().getApplicationContext(),msg);
    }
